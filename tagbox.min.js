Array.prototype.indexOf||(Array.prototype.indexOf=function(f,C){var k;if(null==this)throw new TypeError('"this" is null or not defined');var t=Object(this),v=t.length>>>0;if(0===v)return-1;k=+C||0;Infinity===Math.abs(k)&&(k=0);if(k>=v)return-1;0>k&&(k=v-Math.abs(k));for(k=Math.max(k,0);k<v;){if(k in t&&t[k]===f)return k;k++}return-1});
